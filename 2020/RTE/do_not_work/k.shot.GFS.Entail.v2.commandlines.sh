...
CUDA_VISIBLE_DEVICES=0 python -u k.shot.GFS.Entail.v2.py \
    ...
    --max_seq_length 128 \
    --seed 42 \
    --kshot $SHOT > log.RTE.GFS.Entail.v2.nodropout.$SHOT.shot.seed.42.txt 2>&1 &
...
CUDA_VISIBLE_DEVICES=1 python -u k.shot.GFS.Entail.v2.py \
    ...
    --max_seq_length 128 \
    --seed 16 \
    --kshot $SHOT > log.RTE.GFS.Entail.v2.nodropout.$SHOT.shot.seed.16.txt 2>&1 &
...
CUDA_VISIBLE_DEVICES=2 python -u k.shot.GFS.Entail.v2.py \
    ...
    --max_seq_length 128 \
    --seed 32 \
    --kshot $SHOT > log.RTE.GFS.Entail.v2.nodropout.$SHOT.shot.seed.32.txt 2>&1 &
...
CUDA_VISIBLE_DEVICES=3 python -u k.shot.GFS.Entail.v2.py \
    ...
    --max_seq_length 128 \
    --seed 64 \
    --kshot $SHOT > log.RTE.GFS.Entail.v2.nodropout.$SHOT.shot.seed.64.txt 2>&1 &
...
CUDA_VISIBLE_DEVICES=4 python -u k.shot.GFS.Entail.v2.py \
    ...
    --max_seq_length 128 \
    --seed 128 \
    --kshot $SHOT > log.RTE.GFS.Entail.v2.nodropout.$SHOT.shot.seed.128.txt 2>&1 &
