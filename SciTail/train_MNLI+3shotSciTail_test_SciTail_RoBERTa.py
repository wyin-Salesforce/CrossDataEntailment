...
def main():
    ...
    if args.do_train:
        train_examples = processor.get_SciTail_as_train('/export/home/Dataset/SciTailV1/tsv_format/scitail_1.0_train.tsv', sample_size=10) #train_pu_half_v1.txt
    ...
    pretrain_model_dir = '/export/home/Dataset/BERT_pretrained_mine/crossdataentail/trainMNLItestSciTail/0.8397239263803681' #'roberta-large' , 'roberta-large-mnli'
