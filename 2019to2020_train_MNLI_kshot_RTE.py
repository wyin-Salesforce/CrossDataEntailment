...
class Encoder(BertPreTrainedModel):
    ...
    def forward(self, target_sample_reps_logits_labels, target_sample_last3_reps, source_sample_reps_logits, source_batch_reps_labels,
        ...
        if mode == 'train_NN':
            ...
            overall_test_batch_logits = 0.5*torch.softmax(NN_logits_combine,dim=1)+0.1*torch.softmax(logits_from_pretrained,dim=1)+torch.softmax(CL_logits_from_target,dim=1)
