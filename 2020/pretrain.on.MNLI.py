...
'''
mixup:
CUDA_VISIBLE_DEVICES=0 python -u pretrain.on.MNLI.py --task_name rte --do_train --do_lower_case --num_train_epochs 20 --train_batch_size 5 --eval_batch_size 32 --learning_rate 1e-6 --max_seq_length 128 --seed 42
