...
def main():
    ...
    args.train_batch_size = args.k_shot#min(8, args.k_shot*3)
                ...
                if iter_co %1==0:
                    ...
                    for idd, dev_or_test_dataloader in enumerate([dev_dataloader, eval_dataloader]):
                        ...
                        if idd == 0: # this is dev
                            ...
                            store_transformers_models(model, tokenizer, '/export/home/Dataset/BERT_pretrained_mine/crossdataentail/trainMNLIstiltsRTE'+str(args.k_shot)+'shot', str(max_dev_acc)+'-'+str(test_acc))
